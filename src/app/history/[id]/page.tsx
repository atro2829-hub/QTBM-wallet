...
export default function TransactionDetailPage() {
  ...
  const transactionRef = useMemoFirebase(() => 
    user ? doc(db, 'users', user.uid, 'transactions', transactionId) : null
        ...
        <Card className="rounded-[2.5rem] border-none shadow-xl glass-morphism overflow-hidden">
          <CardContent className="p-6 space-y-5">
            ...
            <div className="space-y-2 pt-2">
               ...
               <p className="text-sm font-bold leading-relaxed bg-primary/5 p-4 rounded-2xl border border-primary/10">
                 {tx.description}
