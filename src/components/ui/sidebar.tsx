        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            <SheetHeader className="sr-only">
              ...
              <SheetDescription>Navigation links and user settings.</SheetDescription>
            </SheetHeader>
...
const SidebarHeaderComp = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => {
  return (
...
SidebarHeaderComp.displayName = "SidebarHeader"
...
export {
  ...
  SidebarGroupContent,
  SidebarGroupLabel,
  SidebarHeaderComp as SidebarHeader,
  SidebarInput,
  SidebarInset,
  SidebarMenu,
  SidebarMenuAction,
