                  ...
                  <Dialog open={isAddingProduct} onOpenChange={setIsAddingProduct}>
                    ...
                    <DialogContent dir="rtl" className="rounded-[2rem] max-w-md border-none shadow-2xl">
                      <DialogHeader>
                        ...
                        <DialogDescription className="text-right">قم بإدخال تفاصيل الخدمة الرقمية الجديدة هنا ليتم عرضها في المتجر.</DialogDescription>
                      </DialogHeader>
                  ...
                  <Dialog open={isAddingPlan} onOpenChange={setIsAddingPlan}>
                    ...
                    <DialogContent dir="rtl" className="rounded-[2rem] max-w-md border-none shadow-2xl">
                      <DialogHeader>
                        ...
                        <DialogDescription className="text-right">حدد شروط وعوائد الخطة الاستثمارية الجديدة التي سيراها المستخدمون.</DialogDescription>
                      </DialogHeader>
                      <div className="space-y-4 pt-4">
              ...
              <TabsContent value="approvals" className="space-y-6">
                <Card className="rounded-[2.5rem] overflow-hidden glass-morphism border-none shadow-xl">
                  <CardHeader className="bg-primary/5 p-8 text-right">
                    ...
                    <CardDescription>قائمة بالتحويلات المالية التي تنتظر تأكيدك اليدوي لتحديث رصيد المستخدم.</CardDescription>
                  </CardHeader>
